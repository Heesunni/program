...
class ReservationRepository:
    ...
    # 특정 예약 조회
    def findOneReservationById(self, reserve_id: int, uid: Optional[str] = None, confirmed: Optional[bool] = None) -> Union[Reservation, None]:
        query = (
            select(Reservation)
    ...
    # 특정 시간 동안의 예약 합계 조회
    def getSumReservationByHours(self, start_date: datetime, end_date: datetime) -> int:
